...
const LookerStudioReport = () => {
  return (
    <>
      <iframe
        src="https://lookerstudio.google.com/embed/reporting/0dcb9a07-35b3-4337-bfc8-b75e7ec9f3df/page/DBskD?theme=light"
        frameBorder="0"
        width="100%"
        height="875"
        style={{
...
const MyComponent = () => {
  ...
  return <button onClick={openPdfInNewTab}>Open PDF in new tab</button>;
};

const Page = () => (
  <>
    <Head>
      <title>Overview | Ministry of Rural Development Kit</title>
    </Head>
    <Box
      component="main"
      sx={{
